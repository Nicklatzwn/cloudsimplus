...
public class DatacenterSimple extends CloudSimEntity implements Datacenter {
    ...
    {
        this(simulation, new ArrayList<>(), vmAllocationPolicy, new DatacenterStorage(),new Point());
    }
    ...
    public DatacenterSimple(
            ...
            final Point thesh)
        {
            this(simulation, new ArrayList<>(), vmAllocationPolicy, new DatacenterStorage(),thesh);
        }
    ...
    public DatacenterSimple(
        ...
        final VmAllocationPolicy vmAllocationPolicy)
    {
        this(simulation, hostList, vmAllocationPolicy, new DatacenterStorage(),new Point());
    }
    ...
    public DatacenterSimple(
            ...
            final Point thesh)
        {
            this(simulation, hostList, vmAllocationPolicy, new DatacenterStorage(),thesh);
        }
    ...
    {
        this(simulation, hostList, vmAllocationPolicy, new DatacenterStorage(storageList),new Point());
    }
    ...
    public DatacenterSimple(
            ...
            final Point thesh)
        {
            this(simulation, hostList, vmAllocationPolicy, new DatacenterStorage(storageList),thesh);
        }
    ...
    public void setPoint(Point thesh) {
    	this.thesh=thesh;
    }
